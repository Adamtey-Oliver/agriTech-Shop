...
<html>
	...
	<body class="subpage">
		...
		<div class="footer-left">
			...
			<div class="logo">
				<a href="blogView.php"><img src="Login/images/logo.png" width="200px"></a>
			</div>
			<br />
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">GH.Farmers<span>Takoradi</span></p>
			</div>
			<div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				...
				AgroCulture is e-commerce trading platform for farmers in Ghana & abroad...
			</p>
