		...
		<!-- Footer -->
			<footer id="footer">
				<div class="container">
					...
					<ul class="copyright">
						<li>&copy; Lezcano Technologies. All rights reserved.</li>
						<li>Design: <a href="http://templated.co">GH.FARMERS</a></li>
						<li>Images: <a href="http://unsplash.com">Online</a></li>
					</ul>
				</div>
			</footer>
